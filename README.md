...
**当前选择复现的论文或方法，并不限定未来的研究方向。** 后续具体研究什么问题，需要结合自己的兴趣、基础和课题条件，与导师讨论后确定。这一阶段的重点是学会如何学习、如何开展科研：主动查找资料、理解论文与代码、设计实验、分析结果和解决问题。不同方向的具体知识需要继续积累，但学习方法和科研思路有很多相通之处；掌握这些能力后，就能更从容地进入新的研究方向。
